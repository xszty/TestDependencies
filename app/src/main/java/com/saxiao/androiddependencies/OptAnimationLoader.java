...
public class OptAnimationLoader {
    ...
    public static Animation getAnimation(Context context,int id){
	    ...
	    try {
	    	...
	    	Resources.NotFoundException rnf = new Resources.NotFoundException(""+Integer.toHexString(id));
	    	rnf.initCause(e);
	    	throw rnf;
	    } finally {
	    	if(parser != null){
    ...
    private static Animation createAnimatFromXml(Context c,XmlResourceParser parser) throws IOException, XmlPullParserException {
